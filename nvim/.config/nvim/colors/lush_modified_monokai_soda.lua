-- autogenerated lush spec on Sat Feb 25 12:22:56 2023
-- Run :Lushify
...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    lualine_c_insert                       { fg="#ffffff", bg="#323742", }, -- lualine_c_insert xxx guifg=#ffffff guibg=#323742
    lualine_a_insert                       { fg="#292d30", gui="bold", bg="#f5ea6a", }, -- lualine_a_insert xxx gui=bold guifg=#292d30 guibg=#f5ea6a
    lualine_b_insert                       { fg="#f5ea6a", bg="#292d30", }, -- lualine_b_insert xxx guifg=#f5ea6a guibg=#292d30
    lualine_c_replace                      { fg="#ffffff", bg="#323742", }, -- lualine_c_replace xxx guifg=#ffffff guibg=#323742
    lualine_a_replace                      { fg="#292d30", gui="bold", bg="#ab6eff", }, -- lualine_a_replace xxx gui=bold guifg=#292d30 guibg=#ab6eff
    lualine_b_replace                      { fg="#ab6eff", bg="#292d30", }, -- lualine_b_replace xxx guifg=#ab6eff guibg=#292d30
    lualine_c_normal                       { fg="#ffffff", bg="#323742", }, -- lualine_c_normal xxx guifg=#ffffff guibg=#323742
    lualine_a_normal                       { fg="#292d30", gui="bold", bg="#ff911b", }, -- lualine_a_normal xxx gui=bold guifg=#292d30 guibg=#ff911b
    lualine_b_normal                       { fg="#ff911b", bg="#292d30", }, -- lualine_b_normal xxx guifg=#ff911b guibg=#292d30
    lualine_c_visual                       { fg="#ffffff", bg="#323742", }, -- lualine_c_visual xxx guifg=#ffffff guibg=#323742
    lualine_a_visual                       { fg="#292d30", gui="bold", bg="#ffffff", }, -- lualine_a_visual xxx gui=bold guifg=#292d30 guibg=#ffffff
    lualine_b_visual                       { fg="#ffffff", bg="#292d30", }, -- lualine_b_visual xxx guifg=#ffffff guibg=#292d30
    lualine_c_command                      { fg="#ffffff", bg="#323742", }, -- lualine_c_command xxx guifg=#ffffff guibg=#323742
    lualine_a_command                      { fg="#292d30", gui="bold", bg="#ffffff", }, -- lualine_a_command xxx gui=bold guifg=#292d30 guibg=#ffffff
    lualine_b_command                      { fg="#ffffff", bg="#292d30", }, -- lualine_b_command xxx guifg=#ffffff guibg=#292d30
    lualine_c_inactive                     { fg="#ffffff", bg="#323742", }, -- lualine_c_inactive xxx guifg=#ffffff guibg=#323742
    lualine_a_inactive                     { fg="#292d30", gui="bold", bg="#ff911b", }, -- lualine_a_inactive xxx gui=bold guifg=#292d30 guibg=#ff911b
    lualine_b_inactive                     { fg="#ff911b", bg="#292d30", }, -- lualine_b_inactive xxx guifg=#ff911b guibg=#292d30
    lualine_c_terminal                     { fg="#ffffff", bg="#323742", }, -- lualine_c_terminal xxx guifg=#ffffff guibg=#323742
    lualine_a_terminal                     { fg="#292d30", gui="bold", bg="#ffffff", }, -- lualine_a_terminal xxx gui=bold guifg=#292d30 guibg=#ffffff
    lualine_b_terminal                     { fg="#ffffff", bg="#292d30", }, -- lualine_b_terminal xxx guifg=#ffffff guibg=#292d30
