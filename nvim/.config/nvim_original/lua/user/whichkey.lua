...
local mappings = {
  ...
  g = {
    ...
    f = { "<cmd>:Git difftool<CR>", "Diffs to quickfix" },
    m = { "<cmd>:Git mergetool<CR>", "Merge conflicts to quickfix" },
  ...
  r = {
    ...
    x = { ':<C-u>lua require("user.extract-react-component").extract_to_function_component()<CR>', "extract JSX (custom)" },
  },
  s = {
    name = "Search",
    b = { "<cmd>Telescope buffers<cr>", "Buffers" },
    B = { "<cmd>lua require('telescope.builtin').current_buffer_fuzzy_find{}<cr>", "Text in buffer" },
    ...
    T = { "<cmd>Telescope dir live_grep<cr>", "Text in Dir" },
